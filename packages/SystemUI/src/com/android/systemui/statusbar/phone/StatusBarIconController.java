...
public class StatusBarIconController extends StatusBarIconList implements Tunable {
    ...
    public StatusBarIconController(Context context, View statusBar, View keyguardStatusBar,
        ...
        TunerService.get(mContext).addTunable(this, ICON_BLACKLIST, Clock.CLOCK_STYLE, Clock.CLOCK_SHOW);
    }
    ...
    public void setClockVisibility(boolean visible) {
        if (mClockStyle == Clock.CLOCK_STYLE_RIGHT_CLOCK && mClock != null) {
    ...
    public void setClockAndDateStatus(int mode, boolean enabled) {
        if (mNotificationIconAreaController != null) {
            mNotificationIconAreaController.setClockAndDateStatus(mode, enabled);
        }
    }
}
